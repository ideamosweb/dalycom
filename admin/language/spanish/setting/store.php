...
// Text
$_['text_success']              = 'Correcto: Ha Modificado la Configuración!';
...
// Entry
$_['entry_url']                 = 'URL de la Tienda:<br /><span class="help">Incluya la URL completa de su Tienda. Este seguro de añadir \'/\' al final. Por ejemplo: http://www.sudominio.com/ruta/<br/><br/>No use Directorios para crear una nueva Tienda. Usted debe siempre apuntar hacia otro Dominio o Sub-Dominio en su Hosting.</span>';
$_['entry_ssl']                 = 'SSL URL:<br /><span class="help">Incluya la SSL URL a su Tienda. Este seguro de añadir \'/\' al final. Por ejemplo: http://www.sudominio.com/ruta/<br/><br/>No use Directorios para crear una nueva Tienda. Usted debe siempre apuntar hacia otro Dominio o Sub-Dominio en su Hosting.</span>';
...
$_['entry_invoice']             = 'Inicio de Factura No.:<br /><span class="help">Configure el número de inicio de las facturas.</span>';
...
$_['entry_order_status']        = 'Estado de la Orden:<br /><span class="help">Predeterminar el Estado de la Orden cuando una compra es Procesada.</span>';
...
$_['entry_use_ssl']             = 'Use SSL:<br /><span class="help">Para usar SSL revise con su host si un certificado SSL se encuentra instalado.</span>';
...
$_['error_store']               = 'Advertencia: Esta tienda no se puede eliminar, ya que está asignada actualmente a %s órdenes';
?>